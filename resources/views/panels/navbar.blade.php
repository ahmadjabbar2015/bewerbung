...
@endphp
@if(  $current_url == route('order.current'))

<nav class="current-order-page-progress-bar header-navbar navbar navbar-expand-lg align-items-center floating-nav-progress {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating'? 'container-xxl p-0': '' }}"></nav>


  @if ($configData['mainLayoutType'] === 'horizontal' && isset($configData['mainLayoutType']))
      <nav class="current-order-page-navbar header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center {{ $configData['navbarColor'] }}"
          data-nav="brand-center">
          <div class="navbar-header d-xl-block d-none">
          </div>
      @else
          <nav
              class="current-order-page-navbar header-navbar navbar navbar-expand-lg align-items-center {{ $configData['navbarClass'] }} navbar-light navbar-shadow {{ $configData['navbarColor'] }} {{ $configData['layoutWidth'] === 'boxed' && $configData['verticalMenuNavbarType'] === 'navbar-floating'? 'container-xxl p-0': '' }}">
  @endif
  
  
    <div class="navbar-container d-flex content">
      <div class="bookmark-wrapper d-flex align-items-center px-2" id="nav-bookmark-wrapper">
          ...
          <div class="d-lg-block mr-2">
            <span id="tasks_completed"> <b> <span id="task_count"> 0 </span> /5 Tasks Completed</b> </span> |
            Complete the tasks To complete the order
            
          </div>
          <div>
            <button class="btn btn-sm btn-success strat-order"> Start Order </button>
          </div>
