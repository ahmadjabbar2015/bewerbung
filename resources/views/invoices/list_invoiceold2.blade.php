        ...
        <div class="card">
            <div class="px-3 pt-3 pb-3">
                <div class="table-wrapper table-responsive">
                    <table class="datatables table table-responsive mb-0" style="color: #000;">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td><a href="{{ url('invoices/' . $order->id) }}" class="text-body font-weight-bold">#{{ $order->id }}</a></td>
                                    <td>
                                        @foreach ($ClientDetail as $client)
                                            <?php
                                            if ($client->order_id == $order->id) {
                                            ?>
                                                 {{-- <img src="{{ asset('images/profiles/'.$client->profile_picture) }}" style="border-radius: 50%;" height="" width="30" alt="">
                                                <span style="color:#0f0f0f; font-size:14px; font-weight:500;"><?php echo $client->first_name . ' ' . $client->last_name;?></span> --}}

                                                    <div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper">
                                                    <div class="avatar  me-1"><img src="{{ asset('images/profiles/'.$client->profile_picture)}}" alt="Avatar" height="32" width="32"></div></div>
                                                    ...
                                                    {{ $client->first_name  }}</span></a><small class="emp_post text-muted">{{$client->email}}</small></div></div>
									...
									<td>
                                        ...
                                        @if ($order->payment_status == 0)
                                            <span class="badge bg-dark"> Un-Paid </span>
                                        @endif
                                        @if ($order->payment_status == -1)
                                   ...
                                   <td style="display:flex;align-items:center; margin-top:26px;">
