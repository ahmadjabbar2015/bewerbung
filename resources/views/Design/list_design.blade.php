                        ...
                        <div class="row">
                            <div class="col-md-9" style="text-align: left">
                                <form action="{{ url('searchdesign') }}" method="POST">
                                    ...
                                    <button style="background-color: #3b3f77;border-color: white;" type="submit"
                                        name="action" value="draft" class="btn btn-primary">{{ __('locale.Design') }} |
                            ...
                            <div class="col-md-3">
                                <a href="{{ 'add_desing' }}" type="button" class="float-right btn btn-success"><i
                                ...
                                <tbody>
                                    @foreach ($designs as $design)
                                        <tr>
                                            ...
                                            <td><img src="{!! asset('images/designs/primary/' . $design->primary_image) !!}" width="150" height="150"
                                                    class="img-thumbnail"></td>
                                            <td><img src="{!! asset('images/designs/secondary/' . $design->secondary_image) !!}" width="150" height="150"
                                                    class="img-thumbnail"></td>
                                            <td>{{ $design->regular_price }}</td>
                                            <td>{{ $design->product_category }}</td>
                                            @if ($trash == false)
                                                <td>
